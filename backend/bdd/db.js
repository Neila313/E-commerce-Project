...
async function initDataBase(con) {
    ...
    await con.query(`CREATE TABLE IF NOT EXISTS articles
             ...
             await con.query(`CREATE TABLE IF NOT EXISTS category 
             (id_category INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
              denomination VARCHAR(250) NOT NULL)`);                 
               //Création de la table produits
        
    await con.query(`CREATE TABLE IF NOT EXISTS products
      ...
      await con.query(`CREATE TABLE IF NOT EXISTS favoris
      ...
      await con.query(`CREATE TABLE IF NOT EXISTS cart
                  (id_cart INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
                    ordered BOOLEAN,
                    id_customer INT NOT NULL,
                    FOREIGN KEY (id_customer) REFERENCES customer(id_customer))`)
      
      await con.query(`CREATE TABLE IF NOT EXISTS cartproduct
